...
var Slider = /** @class */function (_super) {
    ...
    function Slider() {
        ...
        _this.state = {
            ...
            value: _this.props.existingValue ? _this.props.existingValue - _this.props.minimum : 0,
            componentWidth: 0,
            textWidth: 0
        };
        return _this;
    ...
    Slider.prototype.render = function () {
        ...
        var _a = this.props,
            minimum = _a.minimum,
            maximum = _a.maximum,
            thumbWidth = _a.thumbWidth,
            leftText = _a.leftText,
            rightText = _a.rightText,
            showTooltipOnSlide = _a.showTooltipOnSlide,
            leftTextStyle = _a.leftTextStyle,
            rightTextStyle = _a.rightTextStyle;
        var division = maximum - minimum;
        var textLeftCalculation = thumbWidth ? (this.state.componentWidth - thumbWidth) / division * this.state.value + thumbWidth / 2 - this.state.textWidth / 2 : 0;
        ...
        var _b = this.props,
            thumbStyle = _b.thumbStyle,
            trackStyle = _b.trackStyle,
            thumbTextStyle = _b.thumbTextStyle,
            tooltipStyle = _b.tooltipStyle,
            onValueChange = _b.onValueChange,
            step = _b.step;
        return react_1.default.createElement(react_native_1.View, null, react_1.default.createElement(react_native_1.View, { style: styles.topTextsContainer }, leftTopText, rightTopText), react_1.default.createElement(react_native_1.View, { onLayout: function (event) {
            ...
            }] }, react_1.default.createElement(__1.Text, { type: "small", style: [thumbTextStyle, styles.thumbText] }, this.state.value + minimum), showTooltipOnSlide && react_1.default.createElement(react_native_1.View, { style: [styles.tooltip, { display: this.state.showTooltip }] }, react_1.default.createElement(__1.Text, { type: "header4", style: [tooltipStyle, styles.tooltipText] }, this.state.value + minimum)))));
    };
    Slider.defaultProps = {
        step: 1,
        thumbWidth: 50,
