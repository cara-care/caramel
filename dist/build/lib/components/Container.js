...
class Container extends Component {
    render() {
        ...
        return React.createElement(React.Fragment, null, iosStatusBarColor && React.createElement(SafeAreaView, { forceInset: { top: 'always', bottom: 'never' }, style: { flex: 0, backgroundColor: iosStatusBarColor } }), React.createElement(SafeAreaView, { forceInset: {
                top: iosStatusBarColor ? 'never' : 'always',
                bottom: this.props.iosBottomSafeArea ? 'always' : 'never'
            }, style: [styles.root, { backgroundColor: bgColor }] }, React.createElement(View, { style: computedStyles }, children)));
    }
}
