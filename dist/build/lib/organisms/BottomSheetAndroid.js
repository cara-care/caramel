...
var ORIENTATIONS = ['portrait', 'portrait-upside-down', 'landscape', 'landscape-left', 'landscape-right'];
var BottomSheetAndroid = /** @class */function (_super) {
    ...
    BottomSheetAndroid.prototype.setModalVisible = function (visible) {
        var _this = this;
        var _a = this.props,
            minClosingHeight = _a.minClosingHeight,
            duration = _a.duration,
            onClose = _a.onClose;
        var _b = this.state,
            animatedHeight = _b.animatedHeight,
            pan = _b.pan;
        if (visible) {
    ...
    BottomSheetAndroid.prototype.render = function () {
        ...
        var _a = this.props,
            ...
            closeOnPressMask = _a.closeOnPressMask,
            closeOnPressBack = _a.closeOnPressBack,
            closeOnButtonPress = _a.closeOnButtonPress,
            options = _a.options,
        ...
        return react_1.default.createElement(react_native_1.Modal, { transparent: true, animationType: animationType, visible: modalVisible, supportedOrientations: ORIENTATIONS, onRequestClose: function () {
            ...
            } }, react_1.default.createElement(react_native_1.KeyboardAvoidingView, { enabled: react_native_1.Platform.OS === 'ios', behavior: "padding", style: [styles.wrapper, customStyles ? customStyles.wrapper : undefined] }, react_1.default.createElement(react_native_1.TouchableOpacity, { style: styles.mask, activeOpacity: 1, onPress: function () {
                return closeOnPressMask ? _this.close() : null;
            } }), react_1.default.createElement(react_native_1.Animated.View, __assign({}, this.panResponder ? this.panResponder.panHandlers : undefined, { style: [panStyle, styles.container, { height: animatedHeight }, customStyles ? customStyles.container : undefined] }), options && options.map(function (option, index) {
            return react_1.default.createElement(react_native_1.TouchableOpacity, { key: index, onPress: function () {
                ...
                }, style: [styles.button, { height: _this.props.buttonHeight }] }, react_1.default.createElement(react_native_1.Text, { style: styles.text }, option));
        }))));
    };
